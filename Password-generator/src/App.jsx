...
function App() {
  ...
  // useCallback is a react hook that lets you cache a function defintion between re-renders (for optimisation)
  ...
  const copyPasswordToClipboard = useCallback(()=>{
    ...
    // passwordRef.current?.setSelectionRange(0,70); to select/copy only a particular range
